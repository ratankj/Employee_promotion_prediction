...
TRANSFORMED_TRAIN_FILE_PATH= os.path.join(ROOT_DIR, ARTIFACT_DIR_KEY,DATA_TRANSFORMATION_ARTIFACT,
                                          CURRENT_TIME_STAMP,DATA_TRANSFORMED_DIR,TRANSFORMED_TRAIN_DIR_KEY)

TRANSFORMED_TEST_FILE_PATH = os.path.join(ROOT_DIR, ARTIFACT_DIR_KEY,DATA_TRANSFORMATION_ARTIFACT,
                                          CURRENT_TIME_STAMP,DATA_TRANSFORMED_DIR,TRANSFORMED_TEST_DIR_KEY) 
...
MODEL_FILE_PATH = os.path.join(ROOT_DIR,ARTIFACT_DIR_KEY,
                               MODEL_TRAINER_KEY,CURRENT_TIME_STAMP,MODEL_OBJECT)
